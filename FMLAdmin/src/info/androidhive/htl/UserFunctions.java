...
public class UserFunctions {
	...
	private static String loginURL = "http://ssism.org/Api/AdminAPI/";
	...
	private static String makeActiveURL = "http://ssism.org/Api/AdminAPI/post.php";
	private static String login_tag = "login";
	private static String register_tag = "register";
	private static String PostStatus_tag = "poststatus";
	 ...
	 * 
	 */
	public JSONObject ActivePost(String postid)
	{
		List<NameValuePair> params = new ArrayList<NameValuePair>();
		params.add(new BasicNameValuePair("postid", postid));
		params.add(new BasicNameValuePair("Tag", PostStatus_tag));
		Log.i("post id on user function",postid);
		JSONObject json = jsonParser.getJSONFromUrl(makeActiveURL, params);
		return json;
	}
 ...
 */
	 ...
	 */
		 ...
		 * get like post 
		 */
	public JSONObject likepostById(String likeid, String postid, String user_id, String localTime)
		{ 
			// Building Parameters
			List<NameValuePair> params = new ArrayList<NameValuePair>();
...
public JSONObject doComment(String comment, String postid, String user_id, String localTime)
	{ 
		...
		JSONObject json = jsonParser.getJSONFromUrl(doCommentURL, params);
		return json;
	}
